...
### Added
- [#2](https://github.com/norberttech/symfony-process-executor/pull/2) - **PHP ~8.0.0 into composer.json requirements** - [@norberttech](https://github.com/norberttech)
- [#2](https://github.com/norberttech/symfony-process-executor/pull/2) - **Dependabot configuration** - [@norberttech](https://github.com/norberttech)
- [#2](https://github.com/norberttech/symfony-process-executor/pull/2) - **CHANGELOG.md file generated by https://github.com/aeon-php/automation** - [@norberttech](https://github.com/norberttech)

### Changed
- [#2](https://github.com/norberttech/symfony-process-executor/pull/2) - **pull request template** - [@norberttech](https://github.com/norberttech)

### Fixed
- [#2](https://github.com/norberttech/symfony-process-executor/pull/2) - **code snippets in examples** - [@norberttech](https://github.com/norberttech)

## [2.0.2] - 2020-10-25

### Changed
  - [0f9eec](https://github.com/norberttech/symfony-process-executor/commit/0f9eec97d8185924d5172be1cd7ce4b7ffd89deb) - **phar dependencies** - [@norberttech](https://github.com/norberttech)
  - [#1](https://github.com/norberttech/symfony-process-executor/pull/1) - **dependencies, moved tools to phive** - [@norberttech](https://github.com/norberttech)
